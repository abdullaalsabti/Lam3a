...
public class VehicleController : ControllerBase
{
    ...
    public async Task<IActionResult> PostVehicle([FromBody] VehicleDTO vehicleDto)
    {
        ...
        Vehicle vehicleEntity = new Vehicle(vehicleDto.PlateNumber , vehicleDto.BrandId, vehicleDto.ModelId, vehicleDto.Color,vehicleDto.CarType , clientEntity.UserId);
        try{
    ...
    public async Task<IActionResult> DeleteVehicle(string plateNumber)
    {
        ...
        catch (Exception e)
        {
            ...
            return StatusCode(StatusCodes.Status500InternalServerError, new { message = "An error occurred while deleting the vehicle." });
        }
    }
